...
REM
REM See this forum topic for instructions and help with the script:
...
CALL "C:\Program Files (x86)\IntelSWTools\compilers_and_libraries_2017\windows\bin\ipsxe-comp-vars.bat" ia32 vs2010
...
SET NWTC_Lib_Loc=C:\Users\Eric\Desktop\FAST\NWTC Library\Source
SET AeroDyn_Loc=C:\Users\Eric\Desktop\FAST\AeroDyn\Source
SET Wind_Loc=C:\Users\Eric\Desktop\FAST\InflowWind\Source
SET FAST_Loc=C:\Users\Eric\Desktop\FAST\EAControl_FAST\Source
...
ECHO.
ECHO Compiling FAST, AeroDyn, InflowWind, and NWTC_Library routines to create %ROOT_NAME%.exe:

ifort %COMPOPTS% %NWTC_Files% %Wind_Files% %AeroDyn_Files% %FAST_Files% /exe:%ROOT_NAME%.exe %LINKOPTS%
rem ifort %COMPOPTS% %NWTC_Files% %Wind_Files% %AeroDyn_Files% %FAST_Files% %LINKOPTS% /out:%ROOT_NAME%.exe
