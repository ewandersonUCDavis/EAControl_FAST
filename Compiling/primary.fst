...
"..\..\..\NREL5MW_Properties\NRELOffshrBsline5MW_Tower_Onshore.dat"          TwrFile     - Name of file containing tower properties (quoted string)
---------------------- NACELLE-YAW ---------------------------------------------
...
"..\..\..\NREL5MW_Properties\NRELOffshrBsline5MW_Blade.dat"                  BldFile(3)  - Name of file containing properties for blade 3 (quoted string) [unused for 2 blades]
---------------------- AERODYN -------------------------------------------------
...
---------------------- ADAMS ---------------------------------------------------
"..\..\..\NREL5MW_Properties\NRELOffshrBsline5MW_ADAMSSpecific.dat"          ADAMSFile   - Name of file containing ADAMS-specific input parameters (quoted string) [unused when ADAMSPrep=1]
---------------------- LINEARIZATION CONTROL -----------------------------------
"..\..\..\NREL5MW_Properties\NRELOffshrBsline5MW_Linear.dat"                 LinFile     - Name of file containing FAST linearization parameters (quoted string) [unused when AnalMode=1]
---------------------- DERATE PARAMETERS --------------------------------------------------
 150.0		TimeDRStart 	-Time for turbine to initiate derating
 200.0		TimeDREnd		-Time for turbine to start returning to full rated operation
 0.2		DerateFactor	-Ammount turbine will be derated (fraction of 1)
...
"TipDxb2, TipDyb2"                 - Blade 2 flapwise and edgewise tip deflection (m)
"TipDxb3, TipDyb3"                 - Blade 3 flapwise and edgewise tip deflection (m)
"TipDxc1, TipDyc1"      	   - Blade 1 tip out-plane and in-plane defl (m)
"TipDxc2, TipDyc2"      	   - Blade 2 tip out-plane and in-plane defl (m)
"TipDxc3, TipDyc3"      	   - Blade 3 tip out-plane and in-plane defl (m)
