...
MODULE EAControl
   ...
   ! This MODULE stores input variables used for the controllers programmed by Eric Anderson.
...
! These variables are stored here because they are used by several control subroutines.
LOGICAL				 			:: EmergencyShutdown = .FALSE.					! The signal instructing the turbine to execute emergency shutdown. Will remain FALSE unless changed by overspeed or TEmShutdown.
